...
def parse_args():
    ...
    parser.add_argument('--chest_x_ray_path', default='./data/mimic-cxr/img_384/', help="Directory where chest x-ray image data is stored. This should point to the files folder from the MIMIC chest x-ray dataset.")
    parser.add_argument('--radiology_reports_path', default='./data/mimic-cxr/files/', help="Directory radiology reports are stored. This should point to the files folder from the MIMIC radiology reports dataset.")
